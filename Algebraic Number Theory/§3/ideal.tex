...
\usepackage{enumitem}
\usepackage{titlesec}
\usepackage{tikz-cd} % For the exact sequence diagram
...
\subsection*{2. Factorization of Integral Ideals}
...
\subsection*{3. Fractional Ideals and the Ideal Group}
