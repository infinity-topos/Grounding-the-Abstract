...
\subsection{Coface and Codegeneracies}
...
\subsection{ Classifying Space (Nerve)}
...
\subsection{Standard n-Simplex \& Yoneda Lemma}
...
\subsection{Boundary ($\partial \Delta^n$) and Horns ($\Lambda^n_k$)}
...
\subsection{CW Complex Structure and Skeletons ($sk_n X$)}
...
\subsection{Standard Simplex Presentation}
...
\subsection{Coequalizer Presentation}
...
\subsection{Generating Relations}
...
\subsection{Kelley Spaces (CGHaus)}
